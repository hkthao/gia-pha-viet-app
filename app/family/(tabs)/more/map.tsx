...
const MapViewScreen: React.FC = () => {
  ...
  const { data: familyLocationsPaginatedList, isLoading, isError, error } = useFamilyLocations({
    searchQuery: '',
    ...
    return (
      <View style={[styles.page,]}>
        ...
        <View style={styles.loadingOverlay}>
          ...
          <Text variant="titleMedium" style={{ color: theme.colors.onPrimary }}>{t('common.loading')}</Text>
        </View>
      </View>
    );
  }
