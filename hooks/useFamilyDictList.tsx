...
import { PaginatedSearchList } from '@/components/common'; // Assuming PaginatedSearchList will be passed through props or handled by the component
...
export function useFamilyDictList(): UseFamilyDictListHook {
  ...
  ), [theme, getFamilyDictTypeTitle, getFamilyDictLineageTitle, t, styles.familyDictCard, styles.cardContent, styles.namesByRegionContainer, styles.chip]);
