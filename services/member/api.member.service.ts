...
import { MemberListDto, SearchMembersQuery, MemberDetailDto } from '@/types';
...
export class ApiMemberService extends GenericService<MemberListDto, SearchMembersQuery, MemberDetailDto> implements IMemberService {
